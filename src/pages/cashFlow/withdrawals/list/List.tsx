...
import CreateWithdrawals from '../form'
...
const List: FC<Props> = () => {
  ...
  const formButtonTitle = t('cashFlowNewWithdrawal')
  ...
  const onPressFormButtom = () => {
    showModal(ModalForm, {
      cancelable: false,
      title: t('cashFlowWithListModalTitle'),
      message: t('cashFlowWithListModalBody'),
      acceptText: t('cashFlowWithListBtn')
    })
  }
  ...
  return (
    <SearchList
      ...
      renderHeader={() => (
        <HeaderBar
          navigationText={<NavigationText path={t('cashFlowWithdrawalsListPath')} />}
          leftContent={
