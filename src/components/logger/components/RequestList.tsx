...
const RequestList: React.FC<Props> = ({ requests, onPressItem, onShowMore, showDetails }) => {
  ...
  return (
    <View style={styles.container}>
      {!showDetails && <SearchBar value={searchValue} onChangeText={onChangeSearchText} />}
      <FlatList
        ...
        renderItem={({ item }) => <ResultItem request={item} onPress={() => onPressItem(item)} />}
      />
    </View>
  )
}
